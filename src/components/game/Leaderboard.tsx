...
interface LeaderboardProps {
  ...
  customBadge?: (player: any) => React.ReactNode;
  customStatus?: (player: any) => { text?: string; color?: string; score?: number };
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isHighlighted && 'bg-amber-500/20 border border-amber-500/50 ring-2 ring-amber-500/30',
                !isHighlighted && index === 0 && 'bg-gradient-to-r from-yellow-500/20 to-transparent border border-yellow-500/30',
                !isHighlighted && index === 1 && 'bg-gradient-to-r from-gray-400/20 to-transparent',
                !isHighlighted && index === 2 && 'bg-gradient-to-r from-amber-700/20 to-transparent',
                !isHighlighted && index > 2 && 'bg-muted/30',
                !player.isConnected && 'opacity-50'
              )}
            >
              {/* Rank */}
              ...
              <div className="text-right">
                ...
                {status?.score !== undefined && status.score !== 0 && (
                  <p className={cn(
                    ...
                    status.score > 0 ? "text-green-500" : "text-red-500"
                  )}>
